...
./saw_linux_x86_64 example/model4.txt
./saw_linux_x86_64 example/model5.txt
./saw_linux_x86_64 example/model6.txt

We provide the output image for each example in example/.

For the new/user defined model, please refer to readme.md.